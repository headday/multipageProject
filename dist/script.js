...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  new _modules_playVidio__WEBPACK_IMPORTED_MODULE_0__["default"]('.showup .play', '.overlay').init();
  new _modules_playVidio__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__video-item', '.overlay').init();
  var showUpsSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  showUpsSlider.init();
  var modulesSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSlider.init();
  var moduleSlider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.moduleapp',
    btns: '.next'
  });
  moduleSlider.render();
...
/*#__PURE__*/
function () {
  function Differens(oldEducation, newEducation, items) {
    var oldTrigger = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var newTrigger = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(data).then(function (res) {
            console.log(res);
            elem.textContent = _this.massege.succes;
          }).catch(function (err) {
            console.log(err);
            elem.textContent = _this.massege.failure;
          }).finally(function () {
            _this.clearInputs();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VidioPlayer; });
...
/*#__PURE__*/
function () {
  function VidioPlayer(triggers, overlay) {
    _classCallCheck(this, VidioPlayer);
